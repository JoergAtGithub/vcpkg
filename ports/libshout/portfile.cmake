...
# environment CFLAGS set by vcpkg. Passing CFLAGS on the make command line (highest priority)
# overrides the baked-in value in all Makefiles including recursive sub-makes, so the CRT
# flag reaches both the top-level src objects and the icecast-common sub-library objects.
# Using AM_CFLAGS is insufficient because the sub-Makefile COMPILE rules only reference
# $(CFLAGS), not $(AM_CFLAGS).
set(make_options_debug "")
set(make_options_release "")
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    if(VCPKG_CRT_LINKAGE STREQUAL "dynamic")
        list(APPEND make_options_debug "CFLAGS='-O -MDd'")
        list(APPEND make_options_release "CFLAGS='-O -MD'")
    else()
        list(APPEND make_options_debug "CFLAGS='-O -MTd'")
        list(APPEND make_options_release "CFLAGS='-O -MT'")
    endif()
endif()
